...
if __name__ == "__main__":
    num_nodes = 2000  # Number of nodes
    num_layers = 3  # Number of layers
    sparsity = 0.01  # Sparsity of the adjacency matrix

   # Replace with your adjacency matrices
    layer1 = np.load("layer1_adjacency.npy")
    layer2 = np.load("layer2_adjacency.npy")
    layer3 = np.load("layer3_adjacency.npy")
